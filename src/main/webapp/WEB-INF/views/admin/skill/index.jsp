...
<head>
<script type="text/javascript" src="${pageContext.request.contextPath}/admin/js/ace/admin.skill.js"></script>
...
<body>
					...
					<div class="span12">
						<div class="content-widgets ">
							...
							<div class="box well form-inline">
								...
								<a onclick="$.adminSkill.initSearchDataTable()"
	...
	<div class="modal hide fade" id="_modal">
		...
		<div class="modal-footer center" id="div_footer">
			<a class="btn btn-primary" onclick="$.adminSkill.save()">保存</a>
