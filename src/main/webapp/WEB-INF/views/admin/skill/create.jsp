				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form action="${pageContext.request.contextPath}/admin/skill/create" method="post" id=''>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="creater" placeholder="">
								</div>
							</div>
							<div class="control-group">
								<label for="title" class="control-label">来源：</label>
								<div class="controls">
									<input type="text" name="comefrom" placeholder="">
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<textarea  id='context' name='context' style="width: 100%;height: 600px"></textarea>
								</div>
							</div>
