				...
				<div class="row-fluid ">
					<div class="span12">
						<div class="content-widgets light-gray">
							...
							<form class="form-horizontal" method="POST" enctype ="multipart/form-data" action="${pageContext.request.contextPath}/admin/photo/create">
						
							<div class="control-group">
								<label for="title" class="control-label">图片名称：</label>
								<div class="controls">
							...
							<div class="control-group">
								<label for="title" class="control-label">文件：</label>
								<div class="controls">
