...
public class GameController {
	...
	public String save(Game game,Model model) {
	...
	public Map<String, Object> list(
			...
			@RequestParam(value = "iDisplayLength", defaultValue = "10") int iDisplayLength, String gamename
			) throws ParseException {
		int pageNumber = (int) (iDisplayStart / iDisplayLength) + 1;
		int pageSize = iDisplayLength;
		Page<Game> users = gameService.findAll(pageNumber, pageSize, gamename);
