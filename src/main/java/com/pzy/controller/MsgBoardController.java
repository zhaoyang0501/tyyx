...
public class MsgBoardController {
	...
	public String save(MsgBoard msgBoard,Model model) {
	...
	public Map<String, Object> list(
			...
			@RequestParam(value = "iDisplayLength", defaultValue = "10") int iDisplayLength, String msg
			) throws ParseException {
		int pageNumber = (int) (iDisplayStart / iDisplayLength) + 1;
		int pageSize = iDisplayLength;
		Page<MsgBoard> users = msgBoardService.findAll(pageNumber, pageSize, msg);
